...
如果用户想直接改现有批次，也可以让 Agent 执行类似：

```text
Use official-question-import to export the latest batch, rewrite titles in a more natural personal style, preview the diff, and only write back after confirmation.
```
